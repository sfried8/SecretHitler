...
const Policy_1 = __webpack_require__(6);
const models_1 = __webpack_require__(7);
const vue_1 = __webpack_require__(1);
const mint_ui_1 = __webpack_require__(10);
...
const Cookies = __webpack_require__(19);
        ...
        policyChoiceClick: function (index) {
            if (App.amIThePresident()) {
                ...
                mint_ui_1.MessageBox({
                    title: "",
                    message: `Give Chancellor ${this.chancellor.name} ${prettyPrintPolicies(choices)}?`,
